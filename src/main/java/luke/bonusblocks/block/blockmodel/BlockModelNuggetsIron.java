...
public class BlockModelNuggetsIron<T extends Block> extends StandardBlockModel<T> {
    public IconCoordinate[] pebbles = new IconCoordinate[]{TextureRegistry.getTexture("bonusblocks:block/pebbles_iron1"), TextureRegistry.getTexture("bonusblocks:block/pebbles_iron2"), TextureRegistry.getTexture("bonusblocks:block/pebbles_iron3")};
