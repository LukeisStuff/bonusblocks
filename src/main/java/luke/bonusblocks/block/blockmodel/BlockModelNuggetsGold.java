...
public class BlockModelNuggetsGold<T extends BlockLogic> extends BlockModelStandard<T> {
	public IconCoordinate[] pebbles = new IconCoordinate[]{TextureRegistry.getTexture("bonusblocks:block/pebbles_gold/0"), TextureRegistry.getTexture("bonusblocks:block/pebbles_gold/1"), TextureRegistry.getTexture("bonusblocks:block/pebbles_gold/2")};
