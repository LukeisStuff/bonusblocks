...
public class BlockStairsCobblePermafrostConvert extends BlockStairs {

    public BlockStairsCobblePermafrostConvert(Block modelBlock, int id) {
        super(modelBlock, id);
        setTicking(true);
    }
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        if (rand.nextInt(2) == 0) {
            world.setBlockAndMetadataWithNotify(x, y, z, Block.stairsCobblePermafrost.id, world.getBlockMetadata(x, y, z));
        }
    }
    ...
    public void onBlockPlaced(World world, int x, int y, int z, Side side, EntityLiving entity, double sideHeight) {
        ...
        world.setBlockAndMetadataWithNotify(x, y, z, Block.stairsCobblePermafrost.id, meta);
    }

    public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
        return new ItemStack[]{new ItemStack(Block.stairsCobblePermafrost)};
    }
