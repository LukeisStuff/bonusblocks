...
public class BLOCK_COPPERTarnishedPressurePlate extends BlockPressurePlate {
    public BLOCK_COPPERTarnishedPressurePlate(String key, int id, Material material) {
