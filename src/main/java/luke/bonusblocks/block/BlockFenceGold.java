...
public class BlockFenceGold extends BlockFenceThin {
    ...
    public int getTextureIndex() {
        return TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "goldframe.png");
    }
    ...
    public int getTextureIndexAtTop() {
        return TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "goldfence.png");
    }

    public int getColumnTextureIndex() {
        return TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "goldrod.png");
    }
