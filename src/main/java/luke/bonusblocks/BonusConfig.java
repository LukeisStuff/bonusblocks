...
public class BonusConfig {
	public static final Logger LOGGER = LoggerFactory.getLogger(BonusBlocksMod.MOD_ID);

	private static TomlConfigHandler cfg;

	public static final String GeneralCategory = "General";

	private static int BLOCK_ID_STARTING_FROM = 1500;

	public static int currentBlockID;

	private static int ITEM_ID_STARTING_FROM = 16650;
	...
	static void Setup() {
		...
		cfg = new TomlConfigHandler(BonusBlocksMod.MOD_ID, props);
