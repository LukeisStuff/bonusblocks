...
public class TerrainApiPlugin implements TerrainAPI {
    ...
    public void onInitialize() {
        ...
        ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureFlowers(Blocks.FLOWER_YELLOW.id(), 4, true), 4, -1f, 1,
                new Biome[]{Biomes.OVERWORLD_BIRCH_FOREST, Biomes.OVERWORLD_PLAINS, BonusBiomes.OVERWORLD_OVERGROWN_MEADOW});

        ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureFlowers(BonusBlocks.FLOWER_SILVER.id(), 4, true), 4, -1f, 1,
                new Biome[]{Biomes.OVERWORLD_BOREAL_FOREST, Biomes.OVERWORLD_GLACIER, BonusBiomes.OVERWORLD_OVERGROWN_MEADOW});

        ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureFlowers(BonusBlocks.FLOWER_MAGENTA.id(), 4, true), 4, -1f, 1,
                new Biome[]{Biomes.OVERWORLD_TAIGA, BonusBiomes.OVERWORLD_OVERGROWN_MEADOW});

        ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureFlowers(BonusBlocks.FLOWER_CYAN.id(), 4, true), 4, -1f, 1,
        ...
        ChunkDecoratorOverworldAPI.randomFeatures.addFeatureSurface(new WorldFeatureFlowers(BonusBlocks.FLOWER_LIME.id(), 4, true), 4);

        ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureFlowers(BonusBlocks.MUSHROOM_GRAY.id(), 4, false), 6, 1.0f);
    }
}
